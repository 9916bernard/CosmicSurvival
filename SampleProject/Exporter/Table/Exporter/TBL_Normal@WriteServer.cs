...
namespace Table.Exporter
{
    ...
    {
        static public void WriteServer(Defines dfn, string outputPath)
        {
            ...
            WriteServer_VariableDefinition(w, dfn, Util.Tab);
            w.WriteLine("");

            w.WriteLine("{0}void Read(UTableFileStream* fs)", Util.Tab);
            w.WriteLine("{0}{{", Util.Tab);
            WriteServer_ReadFunc(w, dfn, Util.Tab);
            w.WriteLine("{0}}}", Util.Tab);
            ...
            WriteServer_RecordVariable(w, dfn, Util.Tab);
            w.WriteLine("");


            w.WriteLine("{0}bool Load()", Util.Tab);
            w.WriteLine("{0}{{", Util.Tab);
            WriteServer_LoadFunc(w, dfn, Util.Tab + Util.Tab);
            w.WriteLine("{0}}}", Util.Tab);
            ...
            w.WriteLine("{0}{{", Util.Tab);
            WriteServer_UnloadFunc(w, dfn, Util.Tab + Util.Tab);
            w.WriteLine("{0}}}", Util.Tab);

            WriteServer_FindFunc(w, dfn, Util.Tab);
        ...
        static private void WriteServer_VariableDefinition(StreamWriter w, Defines dfn, string tab)
        {
            for (int i = 0; i < dfn.mElements.Count; ++i)
            {
                Defines.Element elem = dfn.mElements[i];

                if (elem.mUsage != Defines.Usage.Server && elem.mUsage != Defines.Usage.Both)
                {
                    continue;
                }
        ...
        static private void WriteServer_ReadFunc(StreamWriter w, Defines dfn, string tab)
        {
            tab += Util.Tab;
            ...
            for (int i = 0; i < dfn.mElements.Count; ++i)
            {
                ...
                {
                    case "string": WriteServer_ReadFunc_String(w, elem, tab); break;
                    case "name": WriteServer_ReadFunc_String(w, elem, tab); break;
                    case "json2": WriteServer_ReadFunc_Json2(w, elem, tab); break;
                    case "struct": WriteServer_ReadFunc_Struct(w, dfn, elem, tab); break;
                    default: WriteServer_ReadFunc_Default(w, elem, tab); break;
                }
            }
        }

        static private void WriteServer_ReadFunc_String(StreamWriter w, Defines.Element elem, string tab)
        {
            if (elem.mArray == true)
            {
        ...
        static private void WriteServer_ReadFunc_Json2(StreamWriter w, Defines.Element elem, string tab)
        {
            w.WriteLine("{0}fs->Read(&cnt, 2);", tab);
        ...
        static private void WriteServer_ReadFunc_Struct(StreamWriter w, Defines dfn, Defines.Element elem, string tab)
        {
            ...
            if (st.mContainString == true)
            {
                if (elem.mArray == true)
                {
                    ...
                    for (int i = 0; i < st.mValueTypeKV.Count; ++i)
                    {
                        ...
                        if (tup.Item2 == "string" || tup.Item2 == "name")
                        {
            ...
            {
                WriteServer_ReadFunc_Default(w, elem, tab);
            }
        }

        static private void WriteServer_ReadFunc_Default(StreamWriter w, Defines.Element elem, string tab)
        {
            if (elem.mArray == true)
            {
                w.WriteLine("{0}fs->Read(&cnt, 2);", tab);
        ...
        static private void WriteServer_RecordVariable(StreamWriter w, Defines dfn, string tab)
        {
        ...
        static private void WriteServer_LoadFunc(StreamWriter w, Defines dfn, string tab)
        {
            w.WriteLine("{0}UTableFileStream fs(\"./Table/{1}.tbd\");", tab, dfn.mTableName);
            w.WriteLine("");
        ...
        static private void WriteServer_UnloadFunc(StreamWriter w, Defines dfn, string tab)
        {
            if (dfn.mMultiKeyElement != null)
            {
                if (dfn.mSingleKeyElement != null)
                {
                    WriteServer_UnloadFunc_Type3(w, dfn, tab);
                }
                else
                {
                    WriteServer_UnloadFunc_Type2(w, dfn, tab);
                }
            }
            else
            {
                if (dfn.mSingleKeyElement != null)
                {
                    WriteServer_UnloadFunc_Type1(w, dfn, tab);
                }
                else
                {
                    WriteServer_UnloadFunc_Type0(w, dfn, tab);
                }
            }
        }
        static private void WriteServer_UnloadFunc_Type3(StreamWriter w, Defines dfn, string tab)
        {
        ...
        static private void WriteServer_UnloadFunc_Type2(StreamWriter w, Defines dfn, string tab)
        {
        ...
        static private void WriteServer_UnloadFunc_Type1(StreamWriter w, Defines dfn, string tab)
        {
        ...
        static private void WriteServer_UnloadFunc_Type0(StreamWriter w, Defines dfn, string tab)
        {
        ...
        static private void WriteServer_FindFunc(StreamWriter w, Defines dfn, string tab)
        {
            if (dfn.mMultiKeyElement != null)
            {
                if (dfn.mSingleKeyElement != null)
                {
                    WriteServer_FindFunc_Type2(w, dfn, tab);
                }
                else
                {
                    WriteServer_FindFunc_Type1(w, dfn, tab);
                }
            }
            else if (dfn.mSingleKeyElement != null)
            {
                WriteServer_FindFunc_Type0(w, dfn, tab);
            }
        }
        static private void WriteServer_FindFunc_Type2(StreamWriter w, Defines dfn, string tab)
        {
            w.WriteLine("");
            w.WriteLine("{0}std::unordered_map<{1}, UTB{2}_Record*>* Find({3} key)", tab, dfn.mSingleKeyElement.mDataTypeDef_S, dfn.mTableName
                , dfn.mMultiKeyElement.mDataType == "string" || dfn.mMultiKeyElement.mDataType == "name" ? "const std::wstring&" : dfn.mMultiKeyElement.mDataTypeDef_S);
            w.WriteLine("{0}{{", tab);
            ...
            w.WriteLine("{0}UTB{1}_Record* Find({2} key1, {3} key2)", tab, dfn.mTableName
                , dfn.mMultiKeyElement.mDataType == "string" || dfn.mMultiKeyElement.mDataType == "name" ? "const std::wstring&" : dfn.mMultiKeyElement.mDataTypeDef_S
                , dfn.mSingleKeyElement.mDataType == "string" || dfn.mSingleKeyElement.mDataType == "name" ? "const std::wstring&" : dfn.mSingleKeyElement.mDataTypeDef_S);
            w.WriteLine("{0}{{", tab);
        ...
        static private void WriteServer_FindFunc_Type1(StreamWriter w, Defines dfn, string tab)
        {
            w.WriteLine("");
        ...
        static private void WriteServer_FindFunc_Type0(StreamWriter w, Defines dfn, string tab)
        {
            w.WriteLine("");
