...
public class UTBString_Common_Chs_Record
{
    public int ID;
    public string Text;
...
public class UTBString_Common_Chs
{
    public Dictionary<int, UTBString_Common_Chs_Record> mapTable = new Dictionary<int, UTBString_Common_Chs_Record>();
    ...
    public bool LoadFromStream(BinaryReader fs, byte[] buffer)
    {
        ...
        {
            UTBString_Common_Chs_Record rec = new UTBString_Common_Chs_Record();
    ...
    {
        TextAsset textAsset = Resources.Load("Table/String_Common_Chs") as TextAsset;
    ...
    {
        string filePath = Application.temporaryCachePath + "/Table/String_Common_Chs.txt";
    ...
    public UTBString_Common_Chs_Record Find(int key1)
    {
        UTBString_Common_Chs_Record rec = null;
