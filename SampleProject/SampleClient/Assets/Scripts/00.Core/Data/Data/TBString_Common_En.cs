...
public class UTBString_Common_En_Record
{
    public int ID;
    public string Text;
...
public class UTBString_Common_En
{
    public Dictionary<int, UTBString_Common_En_Record> mapTable = new Dictionary<int, UTBString_Common_En_Record>();
    ...
    public bool LoadFromStream(BinaryReader fs, byte[] buffer)
    {
        ...
        {
            UTBString_Common_En_Record rec = new UTBString_Common_En_Record();
    ...
    {
        TextAsset textAsset = Resources.Load("Table/String_Common_En") as TextAsset;
    ...
    {
        string filePath = Application.temporaryCachePath + "/Table/String_Common_En.txt";
    ...
    public UTBString_Common_En_Record Find(int key1)
    {
        UTBString_Common_En_Record rec = null;
