...
public class UTBString_Common_Ja_Record
{
    public int ID;
    public string Text;
...
public class UTBString_Common_Ja
{
    public Dictionary<int, UTBString_Common_Ja_Record> mapTable = new Dictionary<int, UTBString_Common_Ja_Record>();
    ...
    public bool LoadFromStream(BinaryReader fs, byte[] buffer)
    {
        ...
        {
            UTBString_Common_Ja_Record rec = new UTBString_Common_Ja_Record();
    ...
    {
        TextAsset textAsset = Resources.Load("Table/String_Common_Ja") as TextAsset;
    ...
    {
        string filePath = Application.temporaryCachePath + "/Table/String_Common_Ja.txt";
    ...
    public UTBString_Common_Ja_Record Find(int key1)
    {
        UTBString_Common_Ja_Record rec = null;
