...
public class UTBString_Common_Ko_Record
{
    public int ID;
    public string Text;
...
public class UTBString_Common_Ko
{
    public Dictionary<int, UTBString_Common_Ko_Record> mapTable = new Dictionary<int, UTBString_Common_Ko_Record>();
    ...
    public bool LoadFromStream(BinaryReader fs, byte[] buffer)
    {
        ...
        {
            UTBString_Common_Ko_Record rec = new UTBString_Common_Ko_Record();
    ...
    {
        TextAsset textAsset = Resources.Load("Table/String_Common_Ko") as TextAsset;
    ...
    {
        string filePath = Application.temporaryCachePath + "/Table/String_Common_Ko.txt";
    ...
    public UTBString_Common_Ko_Record Find(int key1)
    {
        UTBString_Common_Ko_Record rec = null;
